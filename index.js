...
(function(){
  var fs, path, _, crypto, Promise, OpenCC, opencc, opts, md5, filepath, find, overwrite, mkdirsIfNotOverwrite, pwd, fileList, dirHead, ignore, ig, originPwd;
  fs = require('fs');
  path = require('path');
  ...
  Promise.map(fileList, function(file){
    ...
    return fs.readFileAsync(ofilepath, 'utf8').then(function(data){
