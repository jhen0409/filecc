...
(function(){
  var fs, path, _, crypto, ignoreParams, Promise, OpenCC, opencc, isText, opts, filepath, find, overwrite, mkdirsIfNotOverwrite, pwd, fileList, dirHead, ignore, ig, originPwd;
  fs = require('fs');
  path = require('path');
